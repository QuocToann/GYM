...
public class CoachScreen extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CoachScreen frame = new CoachScreen();
	...
	public CoachScreen() {
		...
		JLabel lblNewLabel_4 = new JLabel("Coach's name");
		...
		JLabel lblNewLabel_5 = new JLabel("Manange Coach");
		...
		lblNewLabel_4_2_1_2.setBounds(630, 144, 83, 26);
		...
		comboBox_1_1.setBounds(630, 180, 108, 26);
		...
		lblNewLabel_4_2.setBounds(361, 145, 85, 26);
		...
		textField_3.setBounds(361, 181, 158, 26);
		contentPane.add(textField_3);
		
		JScrollPane scrollPane = new JScrollPane();
		scrollPane.setBounds(205, 273, 676, 238);
